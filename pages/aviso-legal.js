      ...
      <div style={{ background: '#FFE2C4', minHeight: '100vh', padding: '0 0 64px' }}>
        ...
        <div style={{ maxWidth: 720, margin: '0 auto', padding: '48px 24px' }}>
          ...
          <section style={{ marginBottom: 32 }}>
            <h2 style={{ fontSize: 18, fontWeight: 700, color: '#1a0d00', marginBottom: 12 }}>1. Titular del sitio web</h2>
          ...
          <section style={{ marginBottom: 32 }}>
            <h2 style={{ fontSize: 18, fontWeight: 700, color: '#1a0d00', marginBottom: 12 }}>2. Objeto y naturaleza del servicio</h2>
            <p style={{ color: '#444', lineHeight: 1.7 }}>
          ...
          <section style={{ marginBottom: 32 }}>
            <h2 style={{ fontSize: 18, fontWeight: 700, color: '#1a0d00', marginBottom: 12 }}>3. Propiedad intelectual</h2>
            <p style={{ color: '#444', lineHeight: 1.7 }}>
          ...
          <section style={{ marginBottom: 32 }}>
            <h2 style={{ fontSize: 18, fontWeight: 700, color: '#1a0d00', marginBottom: 12 }}>4. Limitación de responsabilidad</h2>
            <p style={{ color: '#444', lineHeight: 1.7 }}>
          ...
          <section style={{ marginBottom: 32 }}>
            <h2 style={{ fontSize: 18, fontWeight: 700, color: '#1a0d00', marginBottom: 12 }}>5. Legislación aplicable</h2>
            <p style={{ color: '#444', lineHeight: 1.7 }}>
