      ...
      <div className="min-h-screen bg-[#F7F3EC]">
        ...
        <div className="max-w-3xl mx-auto px-6 pb-20 prose prose-sm">
          ...
          <p>
            ...
            <strong> cobratelo.es</strong> es titularidad de <strong>Miquel Nogueras Ferrer</strong>,
          ...
          <p>
            ...
            propiedad de Miquel Nogueras Ferrer o sus licenciantes, y están protegidos por la
