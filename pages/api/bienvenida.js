        ...
        <body style="margin:0;padding:0;background:#f7f3ec;font-family:sans-serif">
          <div style="max-width:520px;margin:40px auto;background:#ffffff;border-radius:16px;overflow:hidden;box-shadow:0 2px 12px rgba(0,0,0,0.08)">
            ...
            <div style="padding:36px 32px">
              <h1 style="margin:0 0 12px;font-size:24px;font-weight:700;color:#111110;letter-spacing:-0.5px">
              ...
              <a href="https://cobratelo.es/perfil" 
                style="display:inline-block;background:#111110;color:#ffffff;font-weight:700;font-size:15px;padding:14px 28px;border-radius:100px;text-decoration:none;margin-bottom:28px">
                Ver mis ayudas →
              </a>

              <!-- Pasos -->
              <div style="border-top:1px solid #e0dad0;padding-top:24px;margin-bottom:8px">
                <p style="margin:0 0 16px;font-size:13px;font-weight:700;color:#888882;text-transform:uppercase;letter-spacing:1px">Cómo funciona</p>
                ${[
