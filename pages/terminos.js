    ...
    <>
      ...
      <div style={{ background: '#f7f3ec', minHeight: '100vh', padding: '0 0 64px' }}>
        ...
        <div style={{ maxWidth: 720, margin: '0 auto', padding: '48px 24px' }}>
          <h1 style={{ fontSize: 32, fontWeight: 800, color: '#111110', marginBottom: 8 }}>Términos de Uso</h1>
          <p style={{ color: '#888', marginBottom: 40 }}>Última actualización: mayo 2026</p>

          <section style={{ marginBottom: 32 }}>
            <h2 style={{ fontSize: 18, fontWeight: 700, color: '#111110', marginBottom: 12 }}>1. Aceptación de los términos</h2>
          ...
          <section style={{ marginBottom: 32 }}>
            <h2 style={{ fontSize: 18, fontWeight: 700, color: '#111110', marginBottom: 12 }}>2. Descripción del servicio</h2>
            <p style={{ color: '#444', lineHeight: 1.7 }}>
          ...
          <section style={{ marginBottom: 32 }}>
            <h2 style={{ fontSize: 18, fontWeight: 700, color: '#111110', marginBottom: 12 }}>3. Planes y precios</h2>
          ...
          <section style={{ marginBottom: 32 }}>
            <h2 style={{ fontSize: 18, fontWeight: 700, color: '#111110', marginBottom: 12 }}>4. Suscripciones y facturación</h2>
            <p style={{ color: '#444', lineHeight: 1.7 }}>
          ...
          <section style={{ marginBottom: 32 }}>
            <h2 style={{ fontSize: 18, fontWeight: 700, color: '#111110', marginBottom: 12 }}>5. Obligaciones del usuario</h2>
          ...
          <section style={{ marginBottom: 32 }}>
            <h2 style={{ fontSize: 18, fontWeight: 700, color: '#111110', marginBottom: 12 }}>6. Limitación de responsabilidad</h2>
            <p style={{ color: '#444', lineHeight: 1.7 }}>
          ...
          <section style={{ marginBottom: 32 }}>
            <h2 style={{ fontSize: 18, fontWeight: 700, color: '#111110', marginBottom: 12 }}>7. Modificaciones del servicio</h2>
            <p style={{ color: '#444', lineHeight: 1.7 }}>
          ...
          <section style={{ marginBottom: 32 }}>
            <h2 style={{ fontSize: 18, fontWeight: 700, color: '#111110', marginBottom: 12 }}>8. Ley aplicable y jurisdicción</h2>
            <p style={{ color: '#444', lineHeight: 1.7 }}>
