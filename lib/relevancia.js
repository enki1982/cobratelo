...
export function calcularRelevancia(ayuda, perfil) {
  ...
  if (/^subvenci[oó]n directa (al?|a la|als?) .{3,60}$/i.test(nombre) &&
      !/cobratelo|ciudadano|persona|familia|menor|autonomo|empresa/i.test(nombre)) return 0
  if (/subvenci[oó]n.*asociaci[oó]n (de |del |dels )/i.test(nombre)) return 0
